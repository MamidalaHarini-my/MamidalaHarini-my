...
**Inheritance** is an object-oriented programming feature where one class (child/derived) acquires properties and behaviors (methods) from another class (parent/base).
